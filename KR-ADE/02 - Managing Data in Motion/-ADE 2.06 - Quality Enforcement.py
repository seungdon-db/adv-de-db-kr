...
# MAGIC 
# MAGIC delta lake를 이용해서 data lake 를 구성하는 가장 큰 이유중의 하나는 데이터에 대한 품질 보장입니다. Schema Enforcement는 자동으로 적용이 되므로, 추가적인 품질 검사 기능을 더해서 lakehouse에 들어가는 데이터에 대한 품질을 더 높여 보도록 합니다. 
