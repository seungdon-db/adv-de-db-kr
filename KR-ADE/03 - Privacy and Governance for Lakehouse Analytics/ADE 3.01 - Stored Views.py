...
# MAGIC 
# MAGIC Databricks는 ACL을 지원하지만 standard data engineering cluster에서는 기본으로 적용되지는 않는다. 따라서 이 뷰에 대한 기본 권한은 모든 유저에게 주어지며 owner가 정의되지 않는다. 
